...
# If there is an error then you are responsible. Fucking shite!!!
...
# UNK is used for unnecessary words. I think I should rename it to idk, but who cares for my feelings {SOHAM cries :-( }
...
# You can comment these lines, your wish not that I had to read a lot for this.
